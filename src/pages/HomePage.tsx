...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="大阪・京橋のパーソナルコーチング | 矢田谷充則 | 元公安警察官がサポート"
        description="大阪・京橋エリアで、元公安警察官として培った洞察力と問題解決力を活かし、あなたの『変わりたい』を行動へつなげます。京橋駅からのアクセス良好。目標達成・行動変容・自己実現のためのコーチング。初回無料相談受付中。"
        keywords="パーソナルコーチング, 京橋, 大阪, 大阪市, 都島区, 矢田谷充則, 元公安警察官, コーチング, 変わりたい, やる気, 続かない, 目標達成, 行動変容, 自己実現, 筋トレ, 継続力, 無料相談"
      />
