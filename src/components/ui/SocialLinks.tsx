  ...
  const socialLinks = [
    {
      name: "Instagram",
      icon: InstagramIcon,
      url: "https://www.instagram.com/yatagai_coaching/",
      color: "#E4405F",
    ...
    },
    {
      name: "YouTube",
      icon: YoutubeIcon,
      url: "https://www.youtube.com/@yatagai_coaching",
      color: "#FF0000",
    ...
    },
    {
      name: "TikTok",
      icon: TikTokIcon,
      url: "https://www.tiktok.com/@yatagai_coaching",
      color: "#000000",
